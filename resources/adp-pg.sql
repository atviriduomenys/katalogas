...
DROP TABLE IF EXISTS "adp_cms_page" CASCADE;
...
CREATE TABLE "public"."adp_cms_page" (
    ...
    CONSTRAINT "idx_16387_primary" PRIMARY KEY ("id")
) WITH (oids = false);

CREATE INDEX "idx_16387_fkh6y4ejn6r1yjtr6v8sa80u57p" ON "public"."adp_cms_page" USING btree ("parent_id");
...
CREATE TABLE "public"."api_key" (
    ...
    "deleted" boolean,
    "deleted_on" timestamptz,
    CONSTRAINT "idx_16401_primary" PRIMARY KEY ("id"),
    CONSTRAINT "idx_16401_ukr6ixjob39jj0hsrmet0wqg14c" UNIQUE ("api_key")
) WITH (oids = false);

CREATE INDEX "idx_16401_fk2cifbfne14e6w1in2bjbs6sf6" ON "public"."api_key" USING btree ("organization_id");
...
DROP TABLE IF EXISTS "application_usecase" CASCADE;
...
CREATE TABLE "public"."application_usecase" (
    ...
    CONSTRAINT "idx_16413_primary" PRIMARY KEY ("id"),
    CONSTRAINT "idx_16413_uk11k3vo4kqen1xhwxwcxyxthap" UNIQUE ("slug"),
    CONSTRAINT "idx_16413_ukgcp2cvir5gv395nj4aaunob9g" UNIQUE ("uuid")
) WITH (oids = false);

CREATE INDEX "idx_16413_fkjqp9nx7dqbaun7xvfo1e8amsr" ON "public"."application_usecase" USING btree ("user_id");
...
CREATE INDEX "idx_16419_fkotc3v5m7qi13gdgb8octwnhns" ON "public"."application_usecase_dataset_ids" USING btree ("application_usecase_id");
...
CREATE TABLE "public"."catalog" (
    ...
    CONSTRAINT "idx_16423_ukfonoj8vppd708rn65xeusruvf" UNIQUE ("slug"),
    CONSTRAINT "idx_16423_ukn8gavaatg2qytb65skfd278ai" UNIQUE ("identifier")
) WITH (oids = false);

CREATE INDEX "idx_16423_fkne4ved9e7hb0s67yuxkwbyxvh" ON "public"."catalog" USING btree ("licence_id");
...
CREATE TABLE "public"."category" (
    ...
    CONSTRAINT "idx_16430_primary" PRIMARY KEY ("id")
) WITH (oids = false);
...
CREATE TABLE "public"."cms_attachment" (
    ...
    "cms_page_id" bigint,
    CONSTRAINT "idx_16437_primary" PRIMARY KEY ("id")
) WITH (oids = false);

CREATE INDEX "idx_16437_fkd24jc8oag6itrip826odio0d" ON "public"."cms_attachment" USING btree ("cms_page_id");
...
CREATE TABLE "public"."css_rule_override" (
    ...
    "expires" timestamptz,
    "title" text,
    CONSTRAINT "idx_16456_primary" PRIMARY KEY ("id")
) WITH (oids = false);
...
CREATE TABLE "public"."dataset" (
    ...
    CONSTRAINT "idx_16463_primary" PRIMARY KEY ("id"),
    CONSTRAINT "idx_16463_uk2ujrnxoh8v5arnqre8euk4b4u" UNIQUE ("slug"),
    CONSTRAINT "idx_16463_uk95jpd7a0tb2bhuwsv5dy046mm" UNIQUE ("uuid"),
    CONSTRAINT "idx_16463_ukd7wxd99dbggcgonaqkwk0my32" UNIQUE ("internal_id", "organization_id")
) WITH (oids = false);

CREATE INDEX "idx_16463_fk4k59c9bbvkoab5tcmxuawme2k" ON "public"."dataset" USING btree ("licence");

CREATE INDEX "idx_16463_fkfx0j9c430ywhkw66bwubntd2j" ON "public"."dataset" USING btree ("current_structure_id");

CREATE INDEX "idx_16463_fkh5bnale3qsflk1roluhb5boy6" ON "public"."dataset" USING btree ("category_id");

CREATE INDEX "idx_16463_fkk54wag0yfnoycq9r3y987cxe9" ON "public"."dataset" USING btree ("frequency_id");

CREATE INDEX "idx_16463_fkm7p6euln7a9mtx3gq7tyypcs0" ON "public"."dataset" USING btree ("coordinator");

CREATE INDEX "idx_16463_fkn1j40hydq7lndf33pob9o9iql" ON "public"."dataset" USING btree ("manager_id");

CREATE INDEX "idx_16463_fkppoqdno4w41s70hdov9v984wl" ON "public"."dataset" USING btree ("catalog");
...
CREATE TABLE "public"."dataset_distribution" (
    ...
    CONSTRAINT "idx_16470_primary" PRIMARY KEY ("id")
) WITH (oids = false);

CREATE INDEX "idx_16470_fkexb2irkqg90qyai7dwkg1g3yj" ON "public"."dataset_distribution" USING btree ("dataset_id");

CREATE INDEX "idx_16470_fkomy7mq25j3xlxp4jowvmat7d4" ON "public"."dataset_distribution" USING btree ("url_format_id");
...
CREATE INDEX "idx_16477_fkofdfglrgk9uep05wog6x0xcw" ON "public"."dataset_event" USING btree ("user_id");
...
CREATE TABLE "public"."dataset_migrate" (
    ...
    "deleted" boolean,
    "deleted_on" timestamptz,
    CONSTRAINT "idx_16484_primary" PRIMARY KEY ("id"),
    CONSTRAINT "idx_16484_uk95jpd7a0tb2bhuwsv5dy046mm" UNIQUE ("uuid")
) WITH (oids = false);
...
CREATE TABLE "public"."dataset_remark" (
    ...
    "deleted" boolean,
    "deleted_on" timestamptz,
    CONSTRAINT "idx_16491_primary" PRIMARY KEY ("id")
) WITH (oids = false);

CREATE INDEX "idx_16491_fkb787tufhteyfo5l43abdlj46r" ON "public"."dataset_remark" USING btree ("author_id");

CREATE INDEX "idx_16491_fkdf213wga71ph9g7uea9bc1cv6" ON "public"."dataset_remark" USING btree ("dataset_id");
...
CREATE TABLE "public"."dataset_resource" (
    ...
    "deleted" boolean,
    "deleted_on" timestamptz,
    CONSTRAINT "idx_16498_primary" PRIMARY KEY ("id")
) WITH (oids = false);
...
CREATE TABLE "public"."dataset_resource_migrate" (
    ...
    "deleted" boolean,
    "deleted_on" timestamptz,
    CONSTRAINT "idx_16505_primary" PRIMARY KEY ("id")
) WITH (oids = false);
...
CREATE INDEX "idx_16512_fk2v2vvx2loa3lbico9oey4stsj" ON "public"."dataset_structure" USING btree ("dataset_id");
...
CREATE TABLE "public"."dataset_structure_field" (
    ...
    "type" character varying(255),
    "dataset_id" bigint,
    CONSTRAINT "idx_16519_primary" PRIMARY KEY ("id")
) WITH (oids = false);

CREATE INDEX "idx_16519_fk8w1tjayu0ut13h9g7f8f6ryqd" ON "public"."dataset_structure_field" USING btree ("dataset_id");
...
CREATE TABLE "public"."dataset_visit" (
    ...
    "dataset_id" bigint,
    CONSTRAINT "idx_16526_primary" PRIMARY KEY ("id")
) WITH (oids = false);

CREATE INDEX "idx_16526_fk5enxj7egeon3u4arv6t8hr8lf" ON "public"."dataset_visit" USING btree ("dataset_id");
...
CREATE TABLE "public"."distribution_format" (
    ...
    "deleted" boolean,
    "deleted_on" timestamptz,
    CONSTRAINT "idx_16531_primary" PRIMARY KEY ("id")
) WITH (oids = false);
...
CREATE TABLE "public"."email_template" (
    ...
    "subject" text,
    "title" text,
    CONSTRAINT "idx_16536_primary" PRIMARY KEY ("id"),
    CONSTRAINT "idx_16536_uk5bc0ddajl6jdbstkwabi2n092" UNIQUE ("identifier")
) WITH (oids = false);
...
CREATE TABLE "public"."external_site" (
    ...
    "type" character varying(255),
    "url" character varying(255),
    CONSTRAINT "idx_16543_primary" PRIMARY KEY ("id")
) WITH (oids = false);
...
CREATE TABLE "public"."faq" (
    ...
    "deleted" boolean,
    "deleted_on" timestamptz,
    CONSTRAINT "idx_16550_primary" PRIMARY KEY ("id")
) WITH (oids = false);
...
CREATE TABLE "public"."financing_plan" (
    ...
    "deleted" boolean,
    "deleted_on" timestamptz,
    CONSTRAINT "idx_16564_primary" PRIMARY KEY ("id"),
    CONSTRAINT "idx_16564_ukek9xiakdr85a16q9yhwbg5sax" UNIQUE ("organization_id", "year")
) WITH (oids = false);

CREATE INDEX "idx_16564_fkrue1sug7ymabvpx58i6mcf3ux" ON "public"."financing_plan" USING btree ("created_by");
...
CREATE TABLE "public"."financing_plan_state" (
    ...
    "deleted" boolean,
    "deleted_on" timestamptz,
    CONSTRAINT "idx_16569_primary" PRIMARY KEY ("id")
) WITH (oids = false);
...
CREATE TABLE "public"."format" (
    ...
    "rating" bigint,
    "title" character varying(255),
    CONSTRAINT "idx_16576_primary" PRIMARY KEY ("id")
) WITH (oids = false);
...
CREATE TABLE "public"."geoportal_lt_entry" (
    ...
    "deleted" boolean,
    "deleted_on" timestamptz,
    CONSTRAINT "idx_16590_primary" PRIMARY KEY ("id")
) WITH (oids = false);
...
CREATE TABLE "public"."harvested_visit" (
    ...
    CONSTRAINT "idx_16604_primary" PRIMARY KEY ("id")
) WITH (oids = false);

CREATE INDEX "idx_16604_fk4vif4qkrtl19dsxwnii9i0909" ON "public"."harvested_visit" USING btree ("harvesting_result_id");


DROP TABLE IF EXISTS "harvesting_job" CASCADE;
...
CREATE TABLE "public"."harvesting_job" (
    ...
    "organization" bigint,
    "active" boolean,
    CONSTRAINT "idx_16609_primary" PRIMARY KEY ("id")
) WITH (oids = false);

CREATE INDEX "idx_16609_fk2ryi0ker86i5vc5f9p48w64wt" ON "public"."harvesting_job" USING btree ("organization");


DROP TABLE IF EXISTS "harvesting_result" CASCADE;
...
CREATE TABLE "public"."harvesting_result" (
    ...
    "title_en" text,
    "category_id" bigint,
    CONSTRAINT "idx_16616_primary" PRIMARY KEY ("id")
) WITH (oids = false);

CREATE INDEX "idx_16616_fk_harv_result_category" ON "public"."harvesting_result" USING btree ("category_id");

CREATE INDEX "idx_16616_fk_harv_result_harv_job" ON "public"."harvesting_result" USING btree ("job_id");
...
CREATE TABLE "public"."learning_material" (
    ...
    CONSTRAINT "idx_16623_primary" PRIMARY KEY ("id"),
    CONSTRAINT "idx_16623_ukqu11paplkqkt2hyre1e2syjgt" UNIQUE ("uuid")
) WITH (oids = false);

CREATE INDEX "idx_16623_fk67j6xkiixutc3kaxwshn3kd8u" ON "public"."learning_material" USING btree ("user_id");
...
CREATE TABLE "public"."licence" (
    ...
    "deleted" boolean,
    "deleted_on" timestamptz,
    CONSTRAINT "idx_16631_primary" PRIMARY KEY ("id"),
    CONSTRAINT "idx_16631_uk1st8clbrf69hv9gl2nhfm0myw" UNIQUE ("identifier"),
    CONSTRAINT "idx_16631_uk_1st8clbrf69hv9gl2nhfm0myw" UNIQUE ("identifier")
) WITH (oids = false);
...
CREATE TABLE "public"."municipality" (
    ...
    "deleted" boolean,
    "deleted_on" timestamptz,
    CONSTRAINT "idx_16638_primary" PRIMARY KEY ("id")
) WITH (oids = false);
...
CREATE TABLE "public"."national_financing_plan" (
    ...
    CONSTRAINT "idx_16645_ukakpi5bggg3ngiv2l1yocswuwy" UNIQUE ("year")
) WITH (oids = false);
...
CREATE TABLE "public"."news_item" (
    ...
    "is_public" boolean,
    "published" date,
    CONSTRAINT "idx_16655_primary" PRIMARY KEY ("id"),
    CONSTRAINT "idx_16655_uk511y70m0jr63davomeikaxo7v" UNIQUE ("slug"),
    CONSTRAINT "idx_16655_uk6afehd75fw4450ewl63mpmclk" UNIQUE ("uuid")
) WITH (oids = false);

CREATE INDEX "idx_16655_fk2bn8yor8clqe8rr80sc4uwqyn" ON "public"."news_item" USING btree ("user_id");
...
CREATE TABLE "public"."newsletter_subscription" (
    ...
    CONSTRAINT "idx_16650_primary" PRIMARY KEY ("id")
) WITH (oids = false);
...
CREATE TABLE "public"."old_password" (
    ...
    "user_id" bigint,
    CONSTRAINT "idx_16662_primary" PRIMARY KEY ("id")
) WITH (oids = false);

CREATE INDEX "idx_16662_fk3h975gamp3cdbn09ljckuiv3a" ON "public"."old_password" USING btree ("user_id");
...
CREATE TABLE "public"."open_data_gov_lt_entry" (
    ...
    "deleted" boolean,
    "deleted_on" timestamptz,
    CONSTRAINT "idx_16667_primary" PRIMARY KEY ("id")
) WITH (oids = false);
...
CREATE TABLE "public"."organization" (
    ...
    "imageuuid" character(36),
    CONSTRAINT "idx_16674_primary" PRIMARY KEY ("id"),
    CONSTRAINT "idx_16674_ukh2su5s2veeq84vjfeb4s87tep" UNIQUE ("slug"),
    CONSTRAINT "idx_16674_uks9xj0yg0stek0h7hedcn2qro3" UNIQUE ("uuid")
) WITH (oids = false);
...
CREATE TABLE "public"."partner_application" (
    ...
    CONSTRAINT "idx_16681_primary" PRIMARY KEY ("id")
) WITH (oids = false);
...
CREATE TABLE "public"."password_reset_token" (
    ...
    CONSTRAINT "idx_16688_primary" PRIMARY KEY ("id")
) WITH (oids = false);

CREATE INDEX "idx_16688_fk5lwtbncug84d4ero33v3cfxvl" ON "public"."password_reset_token" USING btree ("user_id");
...
CREATE TABLE "public"."published_report" (
    ...
    "data" text,
    "title" text,
    CONSTRAINT "idx_16693_primary" PRIMARY KEY ("id")
) WITH (oids = false);
...
CREATE TABLE "public"."region" (
    ...
    "version" bigint NOT NULL,
    "title" text,
    CONSTRAINT "idx_16700_primary" PRIMARY KEY ("id")
) WITH (oids = false);
...
CREATE TABLE "public"."report" (
    ...
    "deleted" boolean,
    "deleted_on" timestamptz,
    CONSTRAINT "idx_16707_primary" PRIMARY KEY ("id")
) WITH (oids = false);
...
CREATE TABLE "public"."representative" (
    ...
    "deleted" boolean,
    "deleted_on" timestamptz,
    CONSTRAINT "idx_16714_primary" PRIMARY KEY ("id")
) WITH (oids = false);
...
CREATE TABLE "public"."request" (
    ...
    "structure_data" text,
    "structure_filename" character varying(255),
    CONSTRAINT "idx_16721_primary" PRIMARY KEY ("id"),
    CONSTRAINT "idx_16721_uk6dgywmcxa5qo4onrx95vxe5hf" UNIQUE ("slug"),
    CONSTRAINT "idx_16721_ukopq611dvscynyvfpgpbvig29v" UNIQUE ("uuid")
) WITH (oids = false);

CREATE INDEX "idx_16721_fkqws2fdeknk90txm7qnm9bxd07" ON "public"."request" USING btree ("user_id");
...
CREATE TABLE "public"."request_event" (
    ...
    "type" character varying(255),
    "request_id" bigint,
    CONSTRAINT "idx_16728_primary" PRIMARY KEY ("id")
) WITH (oids = false);

CREATE INDEX "idx_16728_fkboyhtgld73e9xslhlemxax5n" ON "public"."request_event" USING btree ("request_id");
...
CREATE TABLE "public"."request_structure" (
    ...
    "deleted" boolean,
    "deleted_on" timestamptz,
    CONSTRAINT "idx_16735_primary" PRIMARY KEY ("id")
) WITH (oids = false);
...
CREATE TABLE "public"."sent_mail" (
    ...
    CONSTRAINT "idx_16742_primary" PRIMARY KEY ("id")
) WITH (oids = false);
...
CREATE TABLE "public"."sso_token" (
    ...
    "user_id" bigint,
    CONSTRAINT "idx_16747_primary" PRIMARY KEY ("id"),
    CONSTRAINT "idx_16747_ukbf4iv8dfxpwfmh5e2xupfqqsa" UNIQUE ("token")
) WITH (oids = false);

CREATE INDEX "idx_16747_fkkju7shggmw61xqmyw2ha2u6hn" ON "public"."sso_token" USING btree ("user_id");
...
CREATE TABLE "public"."suggestion" (
    ...
    "deleted_on" timestamptz,
    "email" text,
    CONSTRAINT "idx_16752_primary" PRIMARY KEY ("id")
) WITH (oids = false);
...
CREATE TABLE "public"."terms_of_use" (
    ...
    "imageuuid" character(36),
    "published" date,
    CONSTRAINT "idx_16759_primary" PRIMARY KEY ("id")
) WITH (oids = false);
...
CREATE TABLE "public"."usecase" (
    ...
    "comment" text,
    "imageuuid" character(36),
    CONSTRAINT "idx_16766_primary" PRIMARY KEY ("id"),
    CONSTRAINT "idx_16766_uk1oeiv5hog092d0ogeb8ra7nig" UNIQUE ("slug"),
    CONSTRAINT "idx_16766_ukfqd3n77pj91v0j47gl6adkyo1" UNIQUE ("uuid")
) WITH (oids = false);

CREATE INDEX "idx_16766_fku1uqn07hiom0uhv2fg22d6ou" ON "public"."usecase" USING btree ("user_id");
...
CREATE INDEX "idx_16772_fkjojfec74pegtfn2xre9ycrkgn" ON "public"."usecase_dataset_ids" USING btree ("usecase_id");
...
CREATE TABLE "public"."usecase_like" (
    ...
    "user_id" bigint,
    CONSTRAINT "idx_16776_primary" PRIMARY KEY ("id")
) WITH (oids = false);
...
CREATE TABLE "public"."user" (
    ...
    CONSTRAINT "idx_16781_primary" PRIMARY KEY ("id"),
    CONSTRAINT "idx_16781_uk_ob8kqyqqgmefl0aco34akdtpe" UNIQUE ("email"),
    CONSTRAINT "idx_16781_ukob8kqyqqgmefl0aco34akdtpe" UNIQUE ("email")
) WITH (oids = false);

CREATE INDEX "idx_16781_fki3ynrf4qjomj2hdjx7ssa3mlh" ON "public"."user" USING btree ("organization_id");
...
CREATE TABLE "public"."user_dataset_subscription" (
    ...
    CONSTRAINT "idx_16788_primary" PRIMARY KEY ("id")
) WITH (oids = false);

CREATE INDEX "idx_16788_fkfuokd2v3s9sdobtggqtiuxjog" ON "public"."user_dataset_subscription" USING btree ("dataset");

CREATE INDEX "idx_16788_fkpbl2oik54h31p0fyq4n72wetv" ON "public"."user_dataset_subscription" USING btree ("user");
...
CREATE TABLE "public"."user_like" (
    ...
    "request_id" bigint,
    "user_id" bigint,
    CONSTRAINT "idx_16793_primary" PRIMARY KEY ("id")
) WITH (oids = false);
...
CREATE TABLE "public"."user_table_preferences" (
    ...
    "user_id" bigint,
    CONSTRAINT "idx_16798_primary" PRIMARY KEY ("id")
) WITH (oids = false);
...
CREATE TABLE "public"."user_vote" (
    ...
    "user_id" bigint,
    "harvested_id" bigint,
    CONSTRAINT "idx_16805_primary" PRIMARY KEY ("id")
) WITH (oids = false);

CREATE INDEX "idx_16805_fk2q50phs57njg6g0qvha1r8703" ON "public"."user_vote" USING btree ("user_id");

CREATE INDEX "idx_16805_fkmaho12gli2m957igj2bxsu7o0" ON "public"."user_vote" USING btree ("harvested_id");

CREATE INDEX "idx_16805_fkq0c0k0uxbtdrldpfdtlq1jai7" ON "public"."user_vote" USING btree ("dataset_id");
