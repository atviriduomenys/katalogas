...
class TestDatasetAccessControl:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            pytest.param("regular_user", "grandchild",True, "PUBLIC", False, id="update, ar_public: regular -> grandchild"),
            pytest.param("random_org_representative", "grandchild",True, "PUBLIC", False, id="update, ar_public: random_org -> grandchild"),
            ...
            pytest.param("regular_user", "grandchild",True, "RESTRICTED", False, id="update, ar_restricted: regular -> grandchild"),
            pytest.param("random_org_representative", "grandchild",True, "RESTRICTED", False, id="update, ar_restricted: random_org -> grandchild"),
            ...
            pytest.param("random_org_representative", "grandchild",True, "NON_PUBLIC", False, id="update, ar_non_public: random_org -> grandchild"),
