...
from vitrina.resources.schedule import setup_remote_file_size_check_schedule
...
class TestFileSchedule(unittest.TestCase):
    ...
    def test_setup_remote_file_size_check_schedule(self, mock_logger, mock_settings, mock_schedule, mock_Schedule):
        ...
        mock_Schedule.objects.filter.assert_called_once_with(name="check_remote_file_sizes")
        mock_filter.delete.assert_called_once()

        mock_schedule.assert_called_once_with(
            "vitrina.resources.tasks.check_and_update_remote_file_sizes",
            name="check_remote_file_sizes",
    ...
    def test_returns_none(self, mock_settings, mock_schedule, mock_Schedule):
        ...
        result = setup_remote_file_size_check_schedule()
