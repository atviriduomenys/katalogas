    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[('PRIORITIZED', 'Įvertinti prioritetai'), ('INVENTORED', 'Inventorintas'), ('FINANCING', 'Įvertintas finansavimas'), ('HAS_DATA', 'Atvertas'), ('METADATA', 'Parengti metaduomenys')], max_length=255, null=True)),
