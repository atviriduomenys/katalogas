            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        choices=[
                            ("PRIORITIZED", "Įvertinti prioritetai"),
                            ("INVENTORED", "Inventorintas"),
                            ("METADATA", "Parengti metaduomenys"),
                            ("FINANCING", "Įvertintas finansavimas"),
                            ("HAS_DATA", "Atvertas"),
                        ],
                        max_length=255,
                        null=True,
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.DO_NOTHING,
                        to="vitrina_catalogs.harvestingjob",
                    ),
                ),
            ],
            options={
