    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "description",
                    models.TextField(blank=True, verbose_name="Apibūdinimas"),
                ),
                (
                    "show_filter",
                    models.BooleanField(default=False, verbose_name="Rodyti filtre"),
                ),
            ],
            options={
                "verbose_name": "Tipas",
        ...
        migrations.AddField(
            ...
            field=models.URLField(
                blank=True, null=True, verbose_name="API specifikacija"
            ),
        ),
        migrations.AddField(
            model_name="dataset",
        ...
        migrations.AddField(
            ...
            field=models.BooleanField(
                default=False, verbose_name="DataSeries rinkinys"
            ),
        ),
        migrations.AddField(
            model_name="dataset",
            name="service",
            field=models.BooleanField(
                default=False, verbose_name="DataService rinkinys"
            ),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="vitrina_datasets.dataset",
                        verbose_name="Priklauso rinkiniui",
                    ),
                ),
                (
                    "relation",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT,
                        to="vitrina_datasets.relation",
                        verbose_name="Ryšio tipas",
                    ),
                ),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                to="vitrina_datasets.dataservicespectype",
                verbose_name="API specifikacijos formatas",
            ),
        ),
        migrations.AddField(
            model_name="dataset",
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                related_name="related_datasets",
                to="vitrina_datasets.DatasetRelation",
                verbose_name="Duomenų rinkinio ryšiai",
            ),
        ),
        migrations.AddField(
            model_name="dataset",
            name="type",
            field=models.ManyToManyField(
                to="vitrina_datasets.Type", verbose_name="Tipas"
            ),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "inversive_title",
                    models.CharField(
                        max_length=255, verbose_name="Atvirkštinio ryšio pavadinimas"
                    ),
                ),
                (
                    "master",
