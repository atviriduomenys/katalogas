...
class DatasetIndex(SearchIndex, Indexable):
    ...
    management_area = IntegerField(model_attr='management_area', faceted=True, null=True)
    organization = IntegerField(model_attr='organization__pk', faceted=True, null=True)
    ...
    def prepare_manegement_area(self, obj):
        return obj.management_area

    def prepare_organization(self, obj):
        if obj.organization.pk != obj.management_area:
