...
def change_existing_keys_in_template(apps, schema_editor):
    ...
    template_data = {
        "application-use-case-rejected": """Sveiki,
    ...
    for template in template_data:
        if template in templates_to_insert.keys():
            ...
            email_templates.objects.filter(identifier=template).update(
                template=template_data[template]
            )
...
class Migration(migrations.Migration):
    ...
    operations = [migrations.RunPython(change_existing_keys_in_template)]
