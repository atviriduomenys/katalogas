...
acl: ACL = (
    ...
    | {
        ...
        (AgentEnv, Action.CREATE): (Role.RESOURCE_COORDINATOR,),
        (AgentEnv, Action.VIEW): (Role.RESOURCE_COORDINATOR,),
        (AgentEnv, Action.UPDATE): (Role.RESOURCE_COORDINATOR,),
        (AgentEnv, Action.DELETE): (Role.RESOURCE_COORDINATOR,),
