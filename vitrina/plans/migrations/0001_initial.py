    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "description",
                    models.TextField(blank=True, null=True, verbose_name="Aprašymas"),
                ),
                (
                    "start_date",
                    models.DateField(
                        blank=True, null=True, verbose_name="Projekto pradžios data"
                    ),
                ),
                (
                    "end_date",
                    models.DateField(
                        blank=True, null=True, verbose_name="Projekto pabaigos data"
                    ),
                ),
                (
                    "price",
                    models.FloatField(
                        blank=True, null=True, verbose_name="Projekto biudžetas"
                    ),
                ),
                (
                    "procurement",
                    models.URLField(
                        blank=True, null=True, verbose_name="Viešasis pirkimas"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "created",
                    models.DateField(auto_now_add=True, verbose_name="Sukurta"),
                ),
                (
                    "deadline",
                    models.DateField(
                        blank=True, null=True, verbose_name="Įgyvendinimo terminas"
                    ),
                ),
                (
                    "provider_title",
                    models.CharField(
                        ...
                        max_length=255,
                        null=True,
                        verbose_name="Paslaugų teikėjo pavadinimas",
                    ),
                ),
                (
                    "procurement",
                    models.URLField(
                        blank=True, null=True, verbose_name="Nuoroda į viešąjį pirkimą"
                    ),
                ),
                (
                    "price",
                    models.FloatField(
                        blank=True, null=True, verbose_name="Pirkimo kaina EUR"
                    ),
                ),
                (
                    "project",
            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(
                        auto_now_add=True, verbose_name="Įtraukimo data"
                    ),
                ),
                (
                    "plan",
