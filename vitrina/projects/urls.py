...
from vitrina.projects.views import (
    ProjectListView,
    ProjectDetailView,
    ProjectCreateView,
    ProjectUpdateView,
...
urlpatterns = [
    ...
    path(
        "projects/<int:pk>/datasets/",
        ProjectDatasetsView.as_view(),
    ...
    path(
        ...
        ProjectApiKeysDetailView.as_view(),
        name="project-apikeys-detail",
    ),
    path(
        "projects/<int:pk>/apikeys/<int:apikey_id>/regenerate/",
        ProjectApiKeysRegenerateView.as_view(),
        name="project-apikeys-regenerate",
    ),
    path(
        "projects/<int:pk>/permissions/add/",
        ProjectPermissionsCreateView.as_view(),
        name="project-permissions-create",
    ),
    path(
        "projects/<int:pk>/permissions/<int:apikey_id>/toggle/<int:dataset_id>/",
        ProjectPermissionsToggleView.as_view(),
        name="project-permissions-toggle",
    ),
    path(
        "projects/<int:pk>/datasets/<int:dataset_id>/remove/",
        RemoveDatasetView.as_view(),
