...
from vitrina.requests.views import (
    ...
    RequestStatusStatsView, RequestDatasetStatusStatsView, RequestOrganizationStatsView,
    RequestJurisdictionStatsView, RequestListView, RequestCreateView, RequestUpdateView,
    RequestHistoryView, RequestPublicationStatsView, RequestYearStatsView,
    RequestQuarterStatsView, RequestOrgEditView, RequestOrgDeleteView, RequestDetailView,
    RequestPlanView, RequestCreatePlanView, RequestDeletePlanView, RequestPlansHistoryView,
    RequestDatasetsEditUpdateView, RequestDeletePlanDetailView, RequestRedirectView,
    RequestDatasetsEditView, RequestOrgFiltersUpdate, RequestJurisdictionFiltersUpdate
)


urlpatterns = [
    path('update-request-org-filters/', RequestOrgFiltersUpdate.as_view(), name='update-request-org-filters'),
    path('update-request-jurisdiction-filters/', RequestJurisdictionFiltersUpdate.as_view(),
    ...
    path('requests/stats/dataset-status/', RequestDatasetStatusStatsView.as_view(),
    ...
    path('requests/stats/publication/year/<int:year>/', RequestYearStatsView.as_view(),
         name='request-stats-publication-year'),
    path('requests/stats/publication/quarter/<str:quarter>/', RequestQuarterStatsView.as_view(),
    ...
    path('requests/<int:pk>/datasets/add/edit', RequestDatasetsEditUpdateView.as_view(),
