...
OAUTH_CLIENT_MANAGEMENT_CLASS = env("OAUTH_CLIENT_MANAGEMENT_CLASS", default="vitrina.api.oauth.OAuthClientManagement")
...
OAUTH_SERVER_SCOPES_PATH = env("OAUTH_SERVER_SCOPES_PATH", default="/auth/scopes")
