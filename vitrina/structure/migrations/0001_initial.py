    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "given",
                    models.BooleanField(default=True, verbose_name="Duota savybė"),
                ),
                (
                    "model",
                    models.ForeignKey(
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="vitrina_structure.property",
                        verbose_name="Tėvinė savybė",
                    ),
                ),
                (
                    "ref_model",
            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        blank=True, null=True, verbose_name="Objekto id"
                    ),
                ),
                (
                    "content_type",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(blank=True, max_length=255, verbose_name="Vardas"),
                ),
                (
                    "type",
                    models.CharField(blank=True, max_length=255, verbose_name="Tipas"),
                ),
                (
                    "ref",
                    models.CharField(blank=True, max_length=255, verbose_name="Ryšys"),
                ),
                (
                    "source",
                    models.CharField(
                        blank=True, max_length=255, verbose_name="Šaltinis"
                    ),
                ),
                (
                    "prepare",
                    models.CharField(
                        blank=True, max_length=255, verbose_name="Formulė"
                    ),
                ),
                (
                    "prepare_ast",
                    models.JSONField(blank=True, verbose_name="Formulės AST"),
                ),
                (
                    "level",
                    models.IntegerField(
                        blank=True, null=True, verbose_name="Brandos lygis"
                    ),
                ),
                (
                    "level_given",
                    models.IntegerField(
                        blank=True, null=True, verbose_name="Duotas brandos lygis"
                    ),
                ),
                (
                    "access",
                    models.CharField(
                        blank=True, max_length=255, verbose_name="Prieiga"
                    ),
                ),
                (
                    "uri",
                    models.CharField(
                        blank=True, max_length=255, verbose_name="Žodyno atitikmuo"
                    ),
                ),
                ...
                (
                    "description",
                    models.CharField(
                        blank=True, max_length=255, verbose_name="Aprašymas"
                    ),
                ),
                (
                    "order",
                    models.IntegerField(
                        blank=True, null=True, verbose_name="Rikiavimo tvarka"
                    ),
                ),
                ("object_id", models.PositiveIntegerField(verbose_name="Objekto id")),
                (
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                to="vitrina_structure.model",
                verbose_name="Paveldimas modelis",
            ),
        ),
    ]
