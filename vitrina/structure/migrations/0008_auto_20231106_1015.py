    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "version",
                    models.IntegerField(blank=True, null=True, verbose_name="Versija"),
                ),
                (
                    "created",
                ...
                (
                    "released",
                    models.DateField(
                        blank=True, null=True, verbose_name="Išleidimo data"
                    ),
                ),
                (
                    "description",
                ...
                (
                    "deployed",
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="Įkėlimo į saugyklą data"
                    ),
                ),
                (
                    "dataset",
