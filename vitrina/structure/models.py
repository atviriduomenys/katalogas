...
class Metadata(models.Model):
    ...
    uuid = models.CharField(_("Id"), max_length=512)
    name = models.CharField(_("Vardas"), max_length=512, blank=True)
    type = models.CharField(_("Tipas"), max_length=512, blank=True)
    ref = models.CharField(_("Ryšys"), max_length=512, blank=True)
    source = models.CharField(_("Šaltinis"), max_length=512, blank=True)
    prepare = models.CharField(_("Formulė"), max_length=512, blank=True)
    ...
    uri = models.CharField(_("Žodyno atitikmuo"), max_length=512, blank=True)
    version = models.IntegerField(_("Versija"), blank=True)
    title = models.CharField(_("Pavadinimas"), max_length=512, blank=True)
    ...
    type_args = models.CharField(_("Tipo argumentai"), max_length=512, null=True, blank=True)
