...
urlpatterns = [
    ...
    path(
        ...
        name="viisp-complete-login",
    ),
    path(
        "viisp/complete-login/<token>",
        VIISPCompleteLoginView.as_view(),
        name="viisp-complete-login-token",
    ),
    path(
        "viisp/account-merge/<token>",
        VIISPAccountMergeView.as_view(),
        name="viisp-account-merge",
    ),
    ...
    path(
        "viisp/partner-register/",
        PartnerRegisterView.as_view(),
        name="partner-register",
    ),
    path(
        "viisp/account-inactive/",
